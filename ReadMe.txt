...
　バグが多数ございますので、Bugs_and_Future_Plans.txtをお読みになってからご利用ください。
...
6.Walls LuxorおよびDarwal OSへの導入・起動方法
...
10.バグや問題点、今後の予定（2017/09/16更新）
　【バグ・問題点】
　・労働者が人口を超えることがある
　・求人数がマイナスになる
　・建物を建設したときに、求人数が減ることがある
　・統計メニューの反応が悪い
...
　・総労働者数がマップを読み込むたびにリセットされる（各住民の職場は変わらず）
　・高校と大学のアドオンがまだないため、住民が高校や大学に通えない
　
　【今後の予定】
　・ランドマークも建てられるようにする
　・隣町との接続ややり取りも可能にする
　・MODに対応させる（axファイルをインクルードする方式？）
　・空港や港の建設も可能に
　・他の都市との交易
　・動作をもっと改善する（ループ時に画面に表示されている部分のみループする、など）
