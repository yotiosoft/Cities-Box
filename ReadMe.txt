...
　現在確認されているバグについては、「10.バグや問題点、今後の予定」をご覧ください。
...
5.保存形式について
　通常、ゲームは.cbx形式で保存されます。
　cbx形式のセーブデータは暗号化が施されますが、
　保存時に.cbd形式で保存すると暗号化されないまま保存されます。
　暗号化されない方式では、読み込み時や保存時の所要時間が短くなります。
